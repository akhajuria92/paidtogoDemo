...
import com.aaronevans.paidtogo.data.entities.Donation;
...
import com.aaronevans.paidtogo.data.entities.Summary;
...
public class PoolResponse {
        ...
        @Expose
        private Pivot pivot;
        @SerializedName("gym_locations")
        @Expose
        private ArrayList<GymCheckIns> gymLocations;
        ...
        public ArrayList<GymCheckIns> getGymLocations() {
            return gymLocations;
        }

        public void setGymLocations(ArrayList<GymCheckIns> gymLocations) {
