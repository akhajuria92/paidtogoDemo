 ...
 * SwitchButton.
 */
public class SwitchButtonGreen extends View implements Checkable {
    ...
    public SwitchButtonGreen(Context context) {
        super(context);
        init(context, null);
    }

    public SwitchButtonGreen(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public SwitchButtonGreen(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public SwitchButtonGreen(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        uncheckCircleWidth = optPixelSize(typedArray,
                ...
                dp2pxInt(1.5f));//dp2pxInt(bgviewone.5f);
        ...
        checkLineWidth = optPixelSize(typedArray,
                ...
                dp2pxInt(1f));//dp2pxInt(bgviewone.0f);
    ...
    private void broadcastEvent() {
        if(onCheckedChangeListener != null){
            ...
            onCheckedChangeListener.onCheckedChanged(SwitchButtonGreen.this, isChecked());
        }
    ...
    public interface OnCheckedChangeListener{
        void onCheckedChanged(SwitchButtonGreen view, boolean isChecked);
    }
